...
require (
	...
	k8s.io/cloud-provider v0.23.0-rc.0
...
require (
	...
	k8s.io/apiserver v0.23.0-rc.0 // indirect
	k8s.io/component-helpers v0.23.0-rc.0 // indirect
	k8s.io/controller-manager v0.23.0-rc.0 // indirect
