...
require (
	...
	k8s.io/cloud-provider v0.28.0-alpha.2
...
require (
	...
	k8s.io/apiserver v0.28.0-alpha.2 // indirect
	k8s.io/component-helpers v0.28.0-alpha.2 // indirect
	k8s.io/controller-manager v0.28.0-alpha.2 // indirect
