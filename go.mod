...
require (
	...
	github.com/IBM/vpc-go-sdk v0.39.0
...
require (
	...
	k8s.io/apiserver v0.28.0-alpha.3 // indirect
	k8s.io/component-helpers v0.28.0-alpha.3 // indirect
	k8s.io/controller-manager v0.28.0-alpha.3 // indirect
